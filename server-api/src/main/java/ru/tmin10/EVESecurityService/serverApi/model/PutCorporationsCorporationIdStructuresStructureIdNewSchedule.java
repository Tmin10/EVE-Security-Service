...
public class PutCorporationsCorporationIdStructuresStructureIdNewSchedule {
   ...
   * @return day
  **/
  @ApiModelProperty(example = "null", required = true, value = "Day of the week, zero-indexed to Monday")
   ...
   * @return hour
  **/
  @ApiModelProperty(example = "null", required = true, value = "Hour of the day evetime, zero-indexed to midnight")
